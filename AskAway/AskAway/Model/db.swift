...
class db {
    ...
    func removeSession(session: String, callback: () -> ()){
        self.getDBReference()
        self.reference!.child("Sessions").child(session).setValue(nil)
        self.reference!.child("Questions").child(session).setValue(nil)
        self.reference!.child("Queue").child(session).setValue(nil)
        callback()
    }
    ...
    func updateMessages(question: Question, session: String, callback: () -> ()){
        self.getDBReference()
        self.reference?.child("Questions").child(session).child(question.questionID).child("Messages").setValue(question.messages)
        callback()
    }
    ...
    func tagQuestionAnswered(session: String, question: String, callback: () -> ()){
        self.getDBReference()
        self.reference!.child("Questions").child(session).child(question).child("isAnswered").setValue(true)
        callback()
    }
